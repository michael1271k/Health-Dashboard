...
export const MICRO_TARGETS: MicroTarget[] = [
  { key: 'fiber', label: 'Fiber', target: 30, unit: 'g', kind: 'floor', color: '#34D399',
  ...
  { key: 'protein', label: 'Protein', target: 170, unit: 'g', kind: 'floor', color: '#8B5CF6',
    why: '~2.6 g/kg — high end to preserve lean mass in an aggressive deficit.',
    hkType: 'HKQuantityTypeIdentifierDietaryProtein' },
  { key: 'sodium', label: 'Sodium', target: 3000, unit: 'mg', kind: 'ceiling', color: '#FBBF24',
  ...
  { key: 'potassium', label: 'Potassium', target: 3400, unit: 'mg', kind: 'floor', color: '#22D3EE',
...
export const MICRO_SIGNALS: MicroSignal[] = [
  { key: 'wrist_temp_delta', label: 'Wrist Temp Δ', unit: '°C', reference: '±0.3 °C is normal; a spike can flag illness/overreaching', color: '#FB7185' },
  { key: 'time_in_daylight_min', label: 'Daylight', unit: 'min', reference: 'Aim ≥ 30 min — circadian + vitamin-D synthesis', color: '#FBBF24' },
  { key: 'vo2max', label: 'VO₂ Max', unit: '', reference: 'Cardiorespiratory fitness trend', color: '#22D3EE' },
  { key: 'hrv_ms', label: 'HRV', unit: 'ms', reference: 'Higher vs your baseline = better recovery', color: '#38BDF8' },
  { key: 'blood_oxygen', label: 'Blood O₂', unit: '%', reference: '95–100 % typical at rest', color: '#34D399' },
  { key: 'respiratory_rate', label: 'Resp Rate', unit: '/min', reference: '12–20 /min at rest', color: '#8B5CF6' },
  { key: 'heart_rate_recovery', label: 'HR Recovery', unit: 'bpm', reference: '1-min drop; higher = fitter', color: '#A78BFA' },
]

...
export const PR_TRUTH: Readonly<Record<string, TruthRecord>> = {
  ...
  'Chest Press':               { weight: 40,    e1rm: 53.33,  setVolume: { kg: 37.5,  reps: 12 }, sessionVolume: 1417.5 },
  ...
  'Shoulder Press':                   { weight: 31,    e1rm: 42.25,  setVolume: { kg: 30,    reps: 12 }, sessionVolume: 990 },
  'Single Arm Lateral Raise':    { weight: 5,     e1rm: 7.81,   setVolume: { kg: 5,     reps: 17 }, sessionVolume: 272.5 },
  'Overhead Triceps Extension':            { weight: 12.5,  e1rm: 16.79,  setVolume: { kg: 11.25, reps: 15 }, sessionVolume: 446.25 },
  'Rope Triceps Pushdown':               { weight: 15,    e1rm: 22.39,  setVolume: { kg: 15,    reps: 15 }, sessionVolume: 795 },
  'Single Arm Triceps Pushdown': { weight: 6.25,  e1rm: 9.33,   setVolume: { kg: 6.25,  reps: 15 }, sessionVolume: 175 },
  ...
  'Hammer Curl':                      { weight: 20,    e1rm: 28.17,  setVolume: { kg: 20,    reps: 12 }, sessionVolume: 720 },
  'Reverse EZ-Bar Curl':                 { weight: 15,    e1rm: 21.43,  setVolume: { kg: 15,    reps: 13 }, sessionVolume: 390 },
  'Preacher Curl':             { weight: 17.5,  e1rm: 24.65,  setVolume: { kg: 17.5,  reps: 12 }, sessionVolume: 600 },
  ...
  'Romanian Deadlift':              { weight: 40,    e1rm: 53.33,  setVolume: { kg: 35,    reps: 12 }, sessionVolume: 1260 },
  'Hip Thrust':                { weight: 27.5,  e1rm: 40.44,  setVolume: { kg: 27.5,  reps: 14 }, sessionVolume: 1117.5 },
...
export const PR_LOGGED: Readonly<Record<string, LoggedBest>> = {
  'Overhead Triceps Extension':            { weight: 11.25, e1rm: 16.9,  volume: 168.75, sessionVolume: 446.25 },
  'Calf Press':                          { weight: 70,    e1rm: 101.3, volume: 1012.5, sessionVolume: 3037.5 },
  'Chest Press':               { weight: 40,    e1rm: 53.3,  volume: 450,    sessionVolume: 1350 },
  'Crunch Machine':                      { weight: 57.5,  e1rm: 80.5,  volume: 690,    sessionVolume: 2040 },
  'Hammer Curl':                      { weight: 20,    e1rm: 28,    volume: 240,    sessionVolume: 658 },
  'Shoulder Press':                   { weight: 30,    e1rm: 42,    volume: 360,    sessionVolume: 990 },
  ...
  'Hip Thrust':                { weight: 27.5,  e1rm: 40.3,  volume: 385,    sessionVolume: 1117.5 },
  ...
  'Preacher Curl':             { weight: 17.5,  e1rm: 24.5,  volume: 210,    sessionVolume: 600 },
  ...
  'Romanian Deadlift':              { weight: 40,    e1rm: 53.3,  volume: 420,    sessionVolume: 1260 },
  ...
  'Single Arm Lateral Raise':    { weight: 5,     e1rm: 7.8,   volume: 85,     sessionVolume: 272.5 },
  'Single Arm Triceps Pushdown': { weight: 6.25,  e1rm: 9.4,   volume: 93.75,  sessionVolume: 175 },

...
export const ONYX5: Program = {
  ...
  days: [
    { key: 'cb_a', label: 'Upper A', sub: 'Chest + Back', color: C.cb_a, weekday: 0, exercises: [
      ...
      { name: 'Chest Press', sets: 3, cutSets: 2, wk1Kg: 34, reps: '10–12', restSec: 135, muscles: ['chest', 'triceps'], compound: true },
      ...
      { name: 'Straight-Arm Pulldown', sets: 3, cutSets: 3, wk1Kg: 15, reps: '12–15', restSec: 105, muscles: ['back'] },
      { name: 'Face Pull', sets: 3, cutSets: 3, wk1Kg: 13.75, reps: '12–15', restSec: 105, muscles: ['shoulders', 'back'] },
    ] },
    { key: 'legs_a', label: 'Legs & Core A', sub: 'Quad Focus', color: C.legs_a, weekday: 1, exercises: [
      ...
      { name: 'Reverse Crunch', sets: 3, cutSets: 3, wk1Kg: null, reps: '12–15', restSec: 75, muscles: ['core'] },
    ] },
    { key: 'arms', label: 'Delts & Arms', color: C.arms, weekday: 2, exercises: [
      { name: 'Shoulder Press', sets: 3, cutSets: 3, wk1Kg: 28, reps: '8–10', restSec: 105, muscles: ['shoulders', 'triceps'], compound: true },
      { name: 'Single Arm Lateral Raise', sets: 5, cutSets: 4, wk1Kg: 5, reps: '12–20', restSec: 105, muscles: ['shoulders'], note: 'per side' },
      { name: 'Seated Incline DB Curl', sets: 3, cutSets: 3, wk1Kg: 14, reps: '8–12', restSec: 105, muscles: ['biceps'] },
      { name: 'Overhead Triceps Extension', sets: 3, cutSets: 3, wk1Kg: 9, reps: '10–15', restSec: 90, muscles: ['triceps'] },
      { name: 'Hammer Curl', sets: 3, cutSets: 3, wk1Kg: 16, reps: '10–12', restSec: 105, muscles: ['biceps', 'forearms'] },
    ...
    { key: 'cb_b', label: 'Upper B', sub: 'Chest + Back', color: C.cb_b, weekday: 4, exercises: [
      { name: 'Chest Press', sets: 3, cutSets: 3, wk1Kg: 35, reps: '10–12', restSec: 120, muscles: ['chest', 'triceps'], compound: true },
      ...
      { name: 'Single Arm Lateral Raise', sets: 4, cutSets: 3, wk1Kg: 3.75, reps: '15–20', restSec: 90, muscles: ['shoulders'], note: 'per side' },
      { name: 'Preacher Curl', sets: 3, cutSets: 3, wk1Kg: 15, reps: '8–12', restSec: 105, muscles: ['biceps'] },
      { name: 'Single Arm Triceps Pushdown', sets: 3, cutSets: 3, wk1Kg: 5, reps: '12–15', restSec: 90, muscles: ['triceps'], note: 'per arm' },
    ] },
    ...
    { key: 'legs_b', label: 'Legs & Core B', sub: 'Posterior Focus', color: C.legs_b, weekday: 5, exercises: [
      { name: 'Romanian Deadlift', sets: 4, cutSets: 3, wk1Kg: 30, reps: '8–12', restSec: 120, muscles: ['hamstrings', 'glutes', 'back'], compound: true },
      { name: 'Hip Thrust', sets: 3, cutSets: 3, wk1Kg: 25, reps: '8–15', restSec: 135, muscles: ['glutes'], compound: true },
...
export const HELIX4: Program = {
  ...
  days: [
    { key: 'upper_a', label: 'Upper A', color: C.cb_a, weekday: 1, exercises: [
      { name: 'Incline DB Press', sets: 3, cutSets: 3, wk1Kg: 32, reps: '8–12', restSec: 120, muscles: ['chest', 'shoulders'], compound: true },
      { name: 'Lat Pulldown', sets: 3, cutSets: 3, wk1Kg: 45, reps: '8–12', restSec: 135, muscles: ['back'], compound: true },
      { name: 'Chest Press', sets: 2, cutSets: 0, wk1Kg: 34, reps: '10–12', restSec: 120, muscles: ['chest', 'triceps'], compound: true },
      { name: 'Seated Cable Row (V-Grip)', sets: 3, cutSets: 2, wk1Kg: 38.5, reps: '10–12', restSec: 120, muscles: ['back'], compound: true, note: 'V-grip' },
      { name: 'Seated Incline DB Curl', sets: 3, cutSets: 3, wk1Kg: 14, reps: '8–12', restSec: 105, muscles: ['biceps'] },
    ...
    { key: 'upper_b', label: 'Upper B', color: C.cb_b, weekday: 4, exercises: [
      { name: 'Shoulder Press', sets: 3, cutSets: 3, wk1Kg: 28, reps: '8–10', restSec: 105, muscles: ['shoulders', 'triceps'], compound: true },
      { name: 'Single Arm Lateral Raise', sets: 4, cutSets: 4, wk1Kg: 5, reps: '12–20', restSec: 105, muscles: ['shoulders'], note: 'per side' },
      { name: 'Pec Deck', sets: 2, cutSets: 1, wk1Kg: 47.5, reps: '12–15', restSec: 120, muscles: ['chest'], note: 'cut: rotates with Chest Press (Machine)' },
      { name: 'Seated Cable Row (Wide Grip)', sets: 3, cutSets: 2, wk1Kg: 35, reps: '10–12', restSec: 120, muscles: ['back'], compound: true, note: 'wide bar' },
      { name: 'Hammer Curl', sets: 3, cutSets: 2, wk1Kg: 16, reps: '10–12', restSec: 105, muscles: ['biceps', 'forearms'] },
      { name: 'Single Arm Triceps Pushdown', sets: 2, cutSets: 2, wk1Kg: 5, reps: '12–15', restSec: 90, muscles: ['triceps'], note: 'per arm' },
      { name: 'Reverse EZ-Bar Curl', sets: 2, cutSets: 2, wk1Kg: 15, reps: '12–15', restSec: 90, muscles: ['forearms', 'biceps'] },
      { name: 'Seated DB Wrist Curl', sets: 2, cutSets: 0, wk1Kg: 16, reps: '15–20', restSec: 90, muscles: ['forearms'] },
    ] },
    { key: 'lower_b', label: 'Lower B', color: C.legs_b, weekday: 5, exercises: [
      { name: 'Romanian Deadlift', sets: 3, cutSets: 3, wk1Kg: 26, reps: '8–12', restSec: 120, muscles: ['hamstrings', 'glutes', 'back'], compound: true },
      { name: 'Hip Thrust', sets: 3, cutSets: 3, wk1Kg: 23.5, reps: '8–15', restSec: 135, muscles: ['glutes'], compound: true },
      { name: 'Leg Press', sets: 2, cutSets: 2, wk1Kg: 70, reps: '12–15', restSec: 135, muscles: ['quads', 'glutes'], compound: true, note: 'horizontal sled' },
      { name: 'Hip Adduction', sets: 2, cutSets: 0, wk1Kg: 50, reps: '12–15', restSec: 90, muscles: ['glutes'] },
...
const PPL_PUSH: ProgramExercise[] = [
  ...
  { name: 'Shoulder Press', sets: 3, wk1Kg: 30, reps: '8–12', muscles: ['shoulders', 'triceps'], compound: true, note: 'ramp: 25kg×12 → 30kg×9,8' },
  { name: 'Lateral Raise DB', sets: 4, wk1Kg: 10, reps: '12–20', muscles: ['shoulders'] },
  { name: 'Rope Triceps Pushdown', sets: 3, wk1Kg: 15, reps: '12–15', muscles: ['triceps'] },

...
export const ONYX5: Program = {
  ...
  days: [
    ...
    { key: 'arms', label: 'Delts & Arms', color: C.arms, weekday: 2, exercises: [
      ...
      { name: 'Cable Overhead Extension', sets: 3, cutSets: 3, wk1Kg: 9, reps: '10–15', restSec: 90, muscles: ['triceps'] },
      { name: 'DB Hammer Curl', sets: 3, cutSets: 3, wk1Kg: 16, reps: '10–12', restSec: 105, muscles: ['biceps', 'forearms'] },
    ...
    { key: 'cb_b', label: 'Upper B', sub: 'Chest + Back', color: C.cb_b, weekday: 4, exercises: [
      ...
      { name: 'Single Arm Triceps Pushdown (Cable)', sets: 3, cutSets: 3, wk1Kg: 5, reps: '12–15', restSec: 90, muscles: ['triceps'], note: 'per arm' },
    ] },

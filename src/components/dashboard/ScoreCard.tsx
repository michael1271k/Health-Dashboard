...
function RingSegment({
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 group cursor-default" title={`${label}: ${pct}/100`}>
      <div className="relative w-10 h-10">
        <svg viewBox="0 0 40 40" className="-rotate-90 w-full h-full" aria-hidden="true">
          <circle cx="20" cy="20" r={r} fill="none" stroke="#243040" strokeWidth="4" />
          <circle
            cx="20" cy="20" r={r}
            fill="none"
            stroke={color}
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="flex items-baseline gap-2">
            <span
              ...
              aria-label={`Daily score: ${totalScore} out of 100`}
            >
              {totalScore}
            </span>
            <span className="text-muted-vital text-lg">/100</span>
          </div>

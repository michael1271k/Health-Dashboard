        ...
        return (
          <div key={s.id} className="glass-card px-3 py-2.5 flex items-center gap-3">
            <div className="w-11 shrink-0">
              ...
              <div className="text-[9px] text-muted-vital leading-none mt-0.5">{d.toLocaleDateString('en-IL', { weekday: 'short' })}</div>
            </div>
            ...
            <button onClick={() => onDelete(s)} className="p-1.5 rounded-lg text-muted-vital hover:text-danger hover:bg-danger/10 shrink-0" aria-label="Delete session">

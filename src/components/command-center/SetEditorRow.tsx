 ...
 * haptic stepper chips, reps ±1). Only the active row mounts its slider,
 * keeping long decks light.
 */
    ...
    >
      ...
      <div className="flex items-center gap-2 px-2 py-1.5">
        <button
          type="button"
          onClick={onActivate}
          className="flex-1 min-w-0 flex items-center gap-3 text-left min-h-[40px]"
          aria-expanded={active}
        >
          <span className="text-[10px] font-bold uppercase tracking-wide text-muted w-6 shrink-0">S{index + 1}</span>
          <span className="helix-num text-fluid-base font-bold text-text tabular-nums">

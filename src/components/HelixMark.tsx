    ...
    >
      <defs>
        <linearGradient id={`${g}a`} x1="6" y1="22" x2="10" y2="2" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#19E3B1" /><stop offset="100%" stopColor="#5BFF9D" />
        </linearGradient>
        <linearGradient id={`${g}b`} x1="14" y1="2" x2="18" y2="22" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#38E1FF" /><stop offset="100%" stopColor="#4F9DFF" />
        </linearGradient>
      </defs>
      ...
      <path d="M8.9 7.2 L15.1 7.2" stroke="rgba(234,251,255,0.75)" strokeWidth="1.5" />
      <path d="M7.4 12 L16.6 12" stroke="rgba(234,251,255,0.9)" strokeWidth="1.8" />
      <path d="M8.9 16.8 L15.1 16.8" stroke="rgba(234,251,255,0.75)" strokeWidth="1.5" />
      {/* Specular node */}

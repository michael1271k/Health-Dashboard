 ...
 * "Baseline" badge the first time an exercise is logged.
 */
  ...
  return (
    <div className="space-y-1">
      {intel.deltas.map((d) => {
        ...
        return (
          <div key={d.name} className="flex items-center gap-2 rounded-lg bg-white/[0.02] border border-white/[0.05] px-3 py-2">

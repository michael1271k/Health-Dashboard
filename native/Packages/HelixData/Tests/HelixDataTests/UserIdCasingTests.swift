...
struct UserIdCasingTests {
    ...
    func canonicalIsLowercase() throws {
        ...
        #expect(HelixJSON.canonicalUserID(id) == lower)
    ...
    /// on the spot — the id mint (`newHelixID`), the user id
    ...
    func noRawUuidString() throws {
        let root = URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()   // HelixDataTests
            .deletingLastPathComponent()   // Tests
            .deletingLastPathComponent()   // HelixData
            .deletingLastPathComponent()   // Packages
            .deletingLastPathComponent()   // native
        let roots = [
            root.appending(path: "HelixNative"),
            root.appending(path: "Packages/HelixCore/Sources"),
            root.appending(path: "Packages/HelixData/Sources"),
            root.appending(path: "Packages/HelixUI/Sources"),
        ]
        ...
        #expect(offenders.isEmpty, """
            ...
            SQLite compares TEXT byte for byte. Use `newHelixID()` for a new row id and \
            `HelixJSON.canonicalUserID(_:)` for the signed-in user.

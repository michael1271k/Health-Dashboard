...
///
///   1. **the migration** — `v18` adds the three columns, guarded;
...
struct CardioSetTests {
    ...
    private var treadmill: RemoteSetRow {
        RemoteSetRow(
            ...
            durationSec: 300, incline: 2.0, distanceKm: 0.370
        )
    }
    ...
    private var press: RemoteSetRow {
        RemoteSetRow(
            ...
            durationSec: nil, incline: nil, distanceKm: nil
        )
    }
    ...
    func survivesTheRoundTrip() throws {
        ...
        #expect(columns.isSuperset(of: ["duration_sec", "incline", "distance_km"]))

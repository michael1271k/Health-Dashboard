...
///
/// The fixtures are generated from `src/lib/phases.ts`, which still brands the
/// current era "Helix": Phase 2.5 renamed the NATIVE app and the web keeps its
/// own tags on purpose (decision 2). Rather than drop `eraTag` from the

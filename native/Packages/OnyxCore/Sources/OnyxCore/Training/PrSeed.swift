...
public enum PrSeed {
    ...
    public static let records: [SeededPr] = [
        // Jul 16 · Upper B
        SeededPr(date: "2026-07-16", exercise: "Preacher Curl", setNumber: 2, weightKg: 17.5, reps: 12, axes: [.volume, .e1rm]),
        // Jul 17 · Legs & Core B
        SeededPr(date: "2026-07-17", exercise: "Hip Thrust", setNumber: 1, weightKg: 25, reps: 14, axes: [.volume]),
        // Jul 19 · Upper A
        ...
        // Jul 21 · Delts & Arms
        SeededPr(date: "2026-07-21", exercise: "Shoulder Press", setNumber: 2, weightKg: 30, reps: 11, axes: [.volume, .e1rm]),
        SeededPr(date: "2026-07-21", exercise: "Single Arm Lateral Raise", setNumber: 3, weightKg: 5, reps: 10, axes: [.weight, .e1rm]),
        SeededPr(date: "2026-07-21", exercise: "Overhead Triceps Extension", setNumber: 1, weightKg: 10, reps: 15, axes: [.volume]),
        SeededPr(date: "2026-07-21", exercise: "Overhead Triceps Extension", setNumber: 2, weightKg: 11.25, reps: 13, axes: [.e1rm]),
        SeededPr(date: "2026-07-21", exercise: "Hammer Curl", setNumber: 1, weightKg: 20, reps: 12, axes: [.weight, .volume, .e1rm]),
        // Jul 23 · Upper B
        ...
        SeededPr(date: "2026-07-23", exercise: "Single Arm Lateral Raise", setNumber: 2, weightKg: 5, reps: 13, axes: [.volume, .e1rm]),
        // Jul 24 · Legs & Core B
        SeededPr(date: "2026-07-24", exercise: "Romanian Deadlift", setNumber: 1, weightKg: 35, reps: 12, axes: [.weight, .volume, .e1rm]),
        SeededPr(date: "2026-07-24", exercise: "Hip Thrust", setNumber: 2, weightKg: 27.5, reps: 12, axes: [.e1rm]),
        ...
        // Jul 28 · Delts & Arms
        SeededPr(date: "2026-07-28", exercise: "Single Arm Lateral Raise", setNumber: 1, weightKg: 5, reps: 15, axes: [.volume, .e1rm]),
        SeededPr(date: "2026-07-28", exercise: "Overhead Triceps Extension", setNumber: 1, weightKg: 11.25, reps: 15, axes: [.volume, .e1rm]),
        ...
        // Jul 31 · Legs & Core B
        SeededPr(date: "2026-07-31", exercise: "Hip Thrust", setNumber: 2, weightKg: 27.5, reps: 13, axes: [.volume, .e1rm]),
        ...
        SeededPr(date: "2026-08-02", exercise: "Chest Press", setNumber: 2, weightKg: 40, reps: 8, axes: [.weight]),
    ]

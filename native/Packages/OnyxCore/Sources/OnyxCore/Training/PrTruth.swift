...
public enum PrTruth {
    ...
    public static let book: [String: TruthRecord] = [
        ...
        "Chest Press":               TruthRecord(weight: 40,    e1rm: 53.33,  setVolume: sv(37.5, 12),  sessionVolume: 1417.5),
        ...
        "Shoulder Press":                   TruthRecord(weight: 31,    e1rm: 42.25,  setVolume: sv(30, 12),    sessionVolume: 990),
        "Single Arm Lateral Raise":    TruthRecord(weight: 5,     e1rm: 7.81,   setVolume: sv(5, 17),     sessionVolume: 272.5),
        "Overhead Triceps Extension":            TruthRecord(weight: 12.5,  e1rm: 16.79,  setVolume: sv(11.25, 15), sessionVolume: 446.25),
        "Rope Triceps Pushdown":               TruthRecord(weight: 15,    e1rm: 22.39,  setVolume: sv(15, 15),    sessionVolume: 795),
        "Single Arm Triceps Pushdown": TruthRecord(weight: 6.25,  e1rm: 9.33,   setVolume: sv(6.25, 15),  sessionVolume: 175),
        // Pull
        ...
        "Hammer Curl":                      TruthRecord(weight: 20,    e1rm: 28.17,  setVolume: sv(20, 12),    sessionVolume: 720),
        "Reverse EZ-Bar Curl":                 TruthRecord(weight: 15,    e1rm: 21.43,  setVolume: sv(15, 13),    sessionVolume: 390),
        "Preacher Curl":             TruthRecord(weight: 17.5,  e1rm: 24.65,  setVolume: sv(17.5, 12),  sessionVolume: 600),
        // Legs
        ...
        "Romanian Deadlift":              TruthRecord(weight: 40,    e1rm: 53.33,  setVolume: sv(35, 12),    sessionVolume: 1260),
        "Hip Thrust":                TruthRecord(weight: 27.5,  e1rm: 40.44,  setVolume: sv(27.5, 14),  sessionVolume: 1117.5),
    ...
    public static let logged: [String: LoggedBest] = [
        "Overhead Triceps Extension":            LoggedBest(weight: 11.25, e1rm: 16.9,  volume: 168.75, sessionVolume: 446.25),
        "Calf Press":                          LoggedBest(weight: 70,    e1rm: 101.3, volume: 1012.5, sessionVolume: 3037.5),
        "Chest Press":               LoggedBest(weight: 40,    e1rm: 53.3,  volume: 450,    sessionVolume: 1350),
        "Crunch Machine":                      LoggedBest(weight: 57.5,  e1rm: 80.5,  volume: 690,    sessionVolume: 2040),
        "Hammer Curl":                      LoggedBest(weight: 20,    e1rm: 28,    volume: 240,    sessionVolume: 658),
        "Shoulder Press":                   LoggedBest(weight: 30,    e1rm: 42,    volume: 360,    sessionVolume: 990),
        ...
        "Hip Thrust":                LoggedBest(weight: 27.5,  e1rm: 40.3,  volume: 385,    sessionVolume: 1117.5),
        ...
        "Preacher Curl":             LoggedBest(weight: 17.5,  e1rm: 24.5,  volume: 210,    sessionVolume: 600),
        ...
        "Romanian Deadlift":              LoggedBest(weight: 40,    e1rm: 53.3,  volume: 420,    sessionVolume: 1260),
        ...
        "Single Arm Lateral Raise":    LoggedBest(weight: 5,     e1rm: 7.8,   volume: 85,     sessionVolume: 272.5),
        "Single Arm Triceps Pushdown": LoggedBest(weight: 6.25,  e1rm: 9.4,   volume: 93.75,  sessionVolume: 175),

...
/// `helix://open?path=/nutrition` → a tab.
///
...
public enum DeepLink {
    ...
    /// The path a `helix://` URL asks for, or nil. The FULL path (query and all)
    ...
    public static func safePath(_ raw: String?) -> String? {
        ...
        guard url.scheme?.lowercased() == "helix" else { return nil }

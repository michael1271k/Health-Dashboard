...
struct SwapGoldenTests {
    ...
    private static let helix = ScheduleContext(programId: "apex51", phase: .cut)
    private static func resolver(_ overrides: [String: String] = [:], _ ctx: ScheduleContext = helix) -> ResolveDay {
